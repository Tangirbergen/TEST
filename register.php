...
<title>Registration Page</title>
    ...
    <link rel="stylesheet" type="text/css" href="regstyle.css" media="all" />
    <link rel="stylesheet" type="text/css" href="regstyle2.css" media="all" />
</head>
<body>
<div class="container">
      ...
      <div  class="form">
          ...
          <p class="contact"><label for="name">Surname</label></p> 
          <input id="name" name="surname" placeholder="Last name" required="" tabindex="1" type="text">  
